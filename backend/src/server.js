...
import { createImportInterpretRouter } from './routes/importInterpretRoutes.js';
...
const IMPORT_RATE_LIMIT = createRateLimiter({ windowMs: 60_000, maxRequests: 10, keyPrefix: 'import-interpret' });
...
app.use('/imports', createImportInterpretRouter({ importRateLimit: IMPORT_RATE_LIMIT }));
