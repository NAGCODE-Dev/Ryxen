...
Nota:
- as envs primárias do fluxo agora usam prefixo `RYXEN_`; `CROSSAPP_` segue aceito temporariamente por compatibilidade.
...
export RYXEN_COACH_EMAIL=coach@dominio.com
export RYXEN_COACH_PASSWORD='SenhaForte123'
...
export RYXEN_COACH_EMAIL=coach@dominio.com
export RYXEN_COACH_PASSWORD='SenhaForte123'
export RYXEN_ATHLETE_EMAIL=athlete1.test@ryxen.local
export RYXEN_ATHLETE_PASSWORD='Athlete123'
